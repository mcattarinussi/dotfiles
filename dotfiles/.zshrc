...
export N_PREFIX=$(yarn global dir)/node_modules/n
# make sure n managed node will take precedence over the global version
export PATH=$N_PREFIX/bin:$PATH

### Go ###
export GOPATH=$HOME/code/go
# export GOROOT=$HOME/.local/lib/go/go1.10
